...
* `x-expand-all` - (optional) to enable expand all feature, you have to specify comma-separated list of nested expandable collection fields if any. Supported on form field only, not on top-level grid.
