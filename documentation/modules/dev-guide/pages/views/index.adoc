...
In chapter we will see the object views. The object views are xml definitions
about the user interface to represent the object models to the end users.

The {page-component-title} support several kind of views for an object. These includes:
