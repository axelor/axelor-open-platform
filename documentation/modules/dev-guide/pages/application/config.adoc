...
application.sign-in.title = html # Translatable sanitized HTML, shown after the logo in the form login panel.
application.sign-in.footer = html # Translatable sanitized HTML, shown after the form login panel.

application.sign-in.fields.username.show-title = true (default) | false # Show or hide the username field title.
application.sign-in.fields.username.title = translatable text # Title for the username field, default is `Username`.
application.sign-in.fields.username.placeholder = translatable text # Placeholder text for the username field, default is empty.
...
application.sign-in.fields.password.show-title = true (default) | false # Show or hide the password field title.
application.sign-in.fields.password.title = translatable text # Title for the password field, default is `Password`.
application.sign-in.fields.password.placeholder = translatable text # Placeholder text for the password field, default is empty.
...
application.sign-in.fields.tenant.show-title = true (default) | false # Show or hide the tenant field title.
application.sign-in.fields.tenant.title = translatable text # Title for the tenant field, default is `Tenant`.

# Extra buttons inside the form login panel using custom button names.
application.sign-in.buttons.<button-name>.title = text # Title for the custom button.
application.sign-in.buttons.<button-name>.type = button (default) | link # Use Button or Link component.
application.sign-in.buttons.<button-name>.variant = primary|secondary|success|danger|info|warning|light|dark # Variant for button styling.
application.sign-in.buttons.<button-name>.icon = icon_name # Bootstrap or Material icon name, shown before the title.
application.sign-in.buttons.<button-name>.link = url # Absolute or relative URL with `:username` support.
application.sign-in.buttons.<button-name>.order = order # Number relative to the Login button (< 0 for before, >= 0 for after).

# Use `submit` button name to customize the Login submit button.
application.sign-in.buttons.submit.title = Sign in # Title for the submit button.
application.sign-in.buttons.submit.type = button # Type of the submit button.
application.sign-in.buttons.submit.variant = primary # Variant for the submit button styling.
application.sign-in.buttons.submit.icon = none # Icon for the submit button, default is none.
----
