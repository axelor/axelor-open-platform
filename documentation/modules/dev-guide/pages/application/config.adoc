...
It requires https://github.com/redis/redis/releases/tag/7.4-rc1[Redis 7.4+] and is currently supported for app-level cache and Hibernate cache, but not for Shiro cache.
