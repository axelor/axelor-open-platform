...
If you want to use {url-mysql}[MySQL], update the JDBC URL : `db.default.url = jdbc:mysql://localhost:3306/my_database`.
...
| `encryption.algorithm` | encryption algorithm (CBC or GCM) | CBC
...
[source,gradle]
----
implementation "org.infinispan:infinispan-hibernate-cache-v62:${infinispan_version}"
...
[source,gradle]
----
implementation "org.redisson:redisson-hibernate-6:${redisson_version}"
----
[source,properties]
----
