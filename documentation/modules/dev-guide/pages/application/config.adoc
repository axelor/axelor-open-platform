...
| `view.allow-customization` | whether to disable views customization |
...
| `api.pagination.max-per-page` | define the maximum number of items per page, -1 means unlimited | -1
