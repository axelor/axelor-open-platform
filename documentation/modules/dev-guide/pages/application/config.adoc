...
When using Redisson, you can provide a configuration file (defaults to `redisson.yaml`) via the `.config.path`-suffixed property that specifies the Redis connection details. Make sure your configuration file exists either in classpath or on file system.
...
See https://redisson.org/docs/configuration/#using-yaml[Redisson configuration documentation] for details about Redisson configuration.
