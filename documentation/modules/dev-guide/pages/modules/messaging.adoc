...
This allows to improve application responsiveness when creating many tracking messages.

**Delayed Feedback**

Tracking messages are not created immediately when a record is modified.
Instead, they appear in the stream after a brief delay.
