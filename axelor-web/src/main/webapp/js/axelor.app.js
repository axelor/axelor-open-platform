  ...
  function AppCtrl($rootScope, $exceptionHandler, $scope, $http, $route, authService, MessageService, NavService) {
    ...
    $scope.showShortcuts = function () {
      ...
      var shortcuts = [
        ...
        [['Ctrl', 'R'], _t('refresh current record')],
        [['Ctrl', 'Q'], _t('close the current view tab')],
        [['Alt', 'F'], _t('search for records')],
        [['Alt', 'G'], _t('select the first record in the grid')],
        [['Ctrl', 'J'], _t('navigate previous page/record')],
        [['Ctrl', 'K'], _t('navigate next page/record')],
