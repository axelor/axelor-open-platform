...
nv.messages = {}; // stores translations
...
//Get translated text
nv.message = function (text) {
	return (nv.messages || {})[text] || text;
};
...
nv.models.multiBarChart = function() {
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (showControls) {
                var controlsData = [
                    { key: nv.message('Grouped'), keyId: 'Grouped', disabled: multibar.stacked() },
                    { key: nv.message('Stacked'), keyId: 'Stacked', disabled: !multibar.stacked() }
                ];
