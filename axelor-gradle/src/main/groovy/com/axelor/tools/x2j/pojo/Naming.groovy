...
/**
 * This class provides naming utilities for code generator.
 *
 */
@CompileStatic
final class Naming {
	...
	// PostgreSQL 9.x
	private static final Set<String> RESERVED_POSTGRESQL = new LinkedHashSet<>([
		"all",
		"analyse",
		"analyze",
		"and",
	...
	private static final Set<String> RESERVED_MYSQL = new LinkedHashSet<>([
		"accessible",
		"add",
		"all",
		"alter",
	...
	// Oracle
	private static final Set<String> RESERVED_ORACLE = new LinkedHashSet<String>([
		"access",
		"add",
		"all",
		"alter",
