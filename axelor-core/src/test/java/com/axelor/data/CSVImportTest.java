...
public class CSVImportTest {
	...
	public void test() throws ClassNotFoundException {
		...
		CSVImporter importer = new CSVImporter(injector, "data/data-test/csv-multi-config.xml");
		...
		importer.runTask(new ImportTask(){
			...
			public void configure() throws IOException {
				input("[sale.order]", new File("data/data-test/csv-multi/so1.csv"));
				input("[sale.order]", new File("data/data-test/csv-multi/so2.csv"));
			}
