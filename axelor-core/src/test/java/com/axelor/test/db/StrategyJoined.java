...
@Entity
@Table(name = "TEST_STRATEGY_JOINED")
@Inheritance(strategy = InheritanceType.JOINED)
public class StrategyJoined extends AuditableModel {

  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TEST_STRATEGY_JOINED_SEQ")
  @SequenceGenerator(
      name = "TEST_STRATEGY_JOINED_SEQ",
      sequenceName = "TEST_STRATEGY_JOINED_SEQ",
      allocationSize = 1)
  private Long id;
