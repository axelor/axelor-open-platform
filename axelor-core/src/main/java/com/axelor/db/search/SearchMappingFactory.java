...
public final class SearchMappingFactory {
  ...
  public SearchMapping get() {
    ...
    mapping
        ...
        .indexed()
        .indexName("users")
        .property("code", ElementType.FIELD)
        .field()
    ...
    mapping
        .entity(MetaFile.class)
        .property("fileName", ElementType.FIELD)
        .field()
        .store(Store.YES)
        .sortableField()
        .property("filePath", ElementType.FIELD)
        .field()
        .bridge(MetaFileBridge.class)
        .property("description", ElementType.FIELD)
        .field();

    mapping
        .entity(DMSFile.class)
        .indexed()
        .indexName("files")
        .property("fileName", ElementType.FIELD)
        .field()
        .store(Store.YES)
        .sortableField()
        .property("relatedModel", ElementType.FIELD)
        .field()
        .property("relatedId", ElementType.FIELD)
        .field()
        .store(Store.YES)
        .property("metaFile", ElementType.FIELD)
        .indexEmbedded()
