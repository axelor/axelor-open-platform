...
/**
 * This class provides some useful methods in JPA context, can be used as a base
 * class for services to make it more convenient.
 *
 */
public abstract class JpaSupport {
	...
	/**
	 * Perform JDBC related task using the {@link Connection} managed by the
	 * current {@link EntityManager}.
	 * 
	 * @param task
