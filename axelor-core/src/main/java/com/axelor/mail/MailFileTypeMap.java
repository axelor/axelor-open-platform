 ...
 *
 * <p>This class uses {@link Files#probeContentType(java.nio.file.Path)} to find file type and
 * fallbacks to {@link MimetypesFileTypeMap} if it can't find the type.
 */
