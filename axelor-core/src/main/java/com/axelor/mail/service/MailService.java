...
public interface MailService {
   ...
   *
   * <p>Generally, it should resolve to the {@link User}, <code>Contact</code>, <code>Partner</code>
   * or <code>Customer</code> that represents a contact.
   *
   * <p>The default implementation resolves to the {@link User} records.
   *
   ...
   *
   * @param matching the match text
   * @param selected already selected email addresses
