...
public class AuthCasRealm extends CasRealm {
	...
	@Inject
	@Override
	public void setCasServerUrlPrefix(@Named("shiro.cas.server.url.prefix") String casServerUrlPrefix) {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(
		...
		final SimpleAuthenticationInfo info = (SimpleAuthenticationInfo) super.doGetAuthenticationInfo(token);
