...
public class ActionView extends Action {
  ...
  @XmlAttribute private Boolean home;
  ...
  /**
   * Return an instance of {@link ActionViewBuilder} that can be used to quickly define {@link
   * ActionView}.
   *
  ...
  /**
   * The {@link ActionViewBuilder} can be used to quickly define {@link ActionView} manually,
   * especially when setting view to {@link ActionResponse}.
   */
