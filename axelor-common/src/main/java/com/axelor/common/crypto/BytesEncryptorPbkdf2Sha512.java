...
public class BytesEncryptorPbkdf2Sha512 extends AbstractBytesEncryptorPbkdf2 {
   ...
   */
  public BytesEncryptorPbkdf2Sha512(OperationMode mode, String password, int iterations) {
   ...
   */
  public BytesEncryptorPbkdf2Sha512(
  ...
  /** Creates a GCM encryptor with the given password. */
  public static BytesEncryptorPbkdf2Sha512 gcm(String password) {
    return new BytesEncryptorPbkdf2Sha512(OperationMode.GCM, password);
  }

  /** Creates a CBC encryptor with the given password. */
  public static BytesEncryptorPbkdf2Sha512 cbc(String password) {
    return new BytesEncryptorPbkdf2Sha512(OperationMode.CBC, password);
  }
}
