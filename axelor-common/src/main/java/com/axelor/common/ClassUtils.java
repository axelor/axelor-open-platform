...
public final class ClassUtils {
	 ...
	 *
	 * @param classLoader
	 *            the ClassLoader to override.
	 * @return the previous context ClassLoader, or null if ClassLoader is not
	 *         overriden.
	 */
	 ...
	 *
	 * <p>
	 * Generally, it is current Thread context ClassLoader. If not available, it
	 * will be the ClassLoader that loaded the {@link ClassUtils}.
	 *
	 * @return the default ClassLoader, or null if system ClassLoader is not
	 *         accessible.
	 */
	...
	/**
	 * Check whether the given class is a CGLIB or ByteBuddy proxy class,
	 * assuming no custom proxy class naming is used.
	 *
	 * @param clazz
	 *            the class to check
	...
	/**
	 * Check whether the given class name is a CGLIB or ByteBuddy proxy class
	 * name, assuming no custom class naming is used.
	 *
	 * @param className
	 ...
	 *
	 * @param proxyClass
	 *            the proxy class whose first real super class is required.
	 * @return the real super class of the given proxy class, or itself if it's
	 *         not a proxy class
	 */
	 ...
	 *
	 * @param location
	 *            the resource location to resolve, either a pseudo 'classpath:'
	 *            url, a 'file:' url or plain resource location.
