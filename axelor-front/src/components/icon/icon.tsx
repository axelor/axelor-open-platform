...
const fa: Record<string, MaterialIconProps["icon"]> = {
  "fa-address": "contact_mail",
  "fa-archive": "inventory_2",
  "fa-arrow": "open_with",
  "fa-balance": "balance",
  "fa-ban": "hide_source",
  "fa-bar": "bar_chart_4_bars",
  "fa-barcode": "barcode",
  "fa-bars": "menu",
  "fa-book": "library_books",
  "fa-briefcase": "business_center",
  ...
  "fa-caret": "arrow_drop_down",
  "fa-check": "done",
  "fa-chevron": "chevron_right",
  "fa-clock": "schedule",
  "fa-cog": "settings",
  "fa-cogs": "engineering",
  "fa-columns": "view_week",
  "fa-comments": "forum",
  "fa-copy": "file_copy",
  "fa-credit": "credit_card",
  "fa-cubes": "trolley",
  ...
  "fa-play": "play_arrow",
  "fa-plus": "add",
  "fa-power": "power_settings_new",
  "fa-print": "print",
  "fa-recycle": "recycling",
  "fa-reply": "reply",
  "fa-search": "search",
  "fa-share": "share_windows",
  "fa-shopping": "shopping_cart",
  "fa-shopping-cart": "shopping_cart",
  "fa-sitemap": "schema",
  "fa-star": "star",
  "fa-step": "flip",
  "fa-sticky": "sticky_note_2",
  "fa-stop": "stop",
  "fa-suitcase": "work",
  "fa-tags": "style",
  "fa-tasks": "checklist",
...
const brands: Record<string, keyof typeof bootstrap> = {
  apple: "apple",
  facebook: "facebook",
  google: "google",
  instagram: "instagram",
...
const findMaterialIcon = (icon: string) => {
  let name = findName(icon).replace(/-/g, "_");
...
const findBootstrapIcon = (icon: string) => {
  ...
  if (icon in brands) found = brands[icon];
...
export const Icon = forwardRef<HTMLElement, IconProps>(
  ({ icon, ...props }, ref) => {
    ...
    return <MaterialIcon icon="question_mark" {...props} ref={ref} />;
  }
);
